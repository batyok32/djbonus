...
from .models import Client, ClientProfile, Company, CompanyProfile, User
...
class ClientListCreateView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        """
        Creating client usign username, password
        Creating client profile usign request.data and clientCreateSerializer
        """
        print("Creating client")
        serializer = self.get_create_serializer(data=request.data)
        if serializer.is_valid():
            try:
                # print("Trying create user for client")
                username = request.data["username"]
                password = request.data["password"]
                client = Client.objects.create_user(
                    username=username, password=password, type="CLIENT"
                )
                client.save()
...
class ClientRetrieveView(generics.RetrieveUpdateDestroyAPIView):
    """
